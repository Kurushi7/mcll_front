...
const Owners: React.FC<OwnerProps> = ({
  open,
  onClose,
  personId,
  parentPersonId,
  ...
  const handleSaveOwner = async (newPerson: PersonModel) => {
    newPerson.type = "owner";
  ...
  return (
    <ThemeProvider theme={customTheme}>
      ...
      >
        <DialogTitle>Create new owners</DialogTitle>
        <DialogContent>
          <PersonForm
            ref={componentRef}
            header=""
        ...
        <DialogActions>
          ...
          <Button onClick={() => onClose(1)}>Close</Button>
        </DialogActions>
      </Dialog>
      {openSnackBar && (
        <Snackbar
